...
import Mental from "./prepa/Mental.jsx";
import Brain from "./prepa/Brain.jsx";
import Sleep from "./prepa/Sleep.jsx";

const TABS = [["today", "📋 Jour"], ["planning", "🗓️ Planning"], ["exam", "📝 Contrôle"], ["drill", "⚡ Drill"], ["flash", "🃏 Par cœur"], ["mental", "🧮 Calcul mental"], ["brain", "🧠 Cerveau"], ["sleep", "🌙 Sommeil"]];
